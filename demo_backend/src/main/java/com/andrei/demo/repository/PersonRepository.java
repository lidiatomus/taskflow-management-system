...
public interface PersonRepository extends JpaRepository<Person, UUID> {
    Optional<Person> findByEmail(String email); //folosit la creare si update ca sa cuatam daca mail ul exista deja
    ...
    List<Person> findByDepartamentId(UUID departamentId);
}
